...
final class DemoDataset {
    ...
    static func standard() -> DemoDataset {
        ...
        return DemoDataset(devices: [mac, vps], spaces: [jolt, edge],
        ...
        case "chat-veil":
            return [
                ...
                MessageEntry(id: "m2", role: .assistant, parts: [
                    ...
                    .tool(id: "tool2", call: RenderToolCall(tag: "editFile", fields: ["path": "Jolt/Transcript/Veil.swift"]), isError: false, resolved: true),
                    .tool(id: "tool3", call: RenderToolCall(tag: "exec", fields: ["command": "xcodebuild -scheme Jolt build"]), isError: false, resolved: true),
                    .text(id: "t1", text: """
        ...
        case "chat-tabs":
            return [
                ...
                MessageEntry(id: "m2", role: .assistant, parts: [
                    ...
                    .tool(id: "tool2", call: RenderToolCall(tag: "exec", fields: ["command": "cargo test -p jolt-ui tool_group"]), isError: true, resolved: true),
